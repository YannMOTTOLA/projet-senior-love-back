...
import { ACCESS_TOKEN_DURATION_IN_MS, generateAccessToken, generateRefreshToken, REFRESH_TOKEN_DURATION_IN_MS, } from "../lib/tokens.js";
...
export async function loginUser(req, res) {
    ...
    if (!user) {
        throw new BadRequestError("L'email et le mot de passe ne correspondent pas");
    }
...
function setTokensInCookies(res, accessToken, refreshToken) {
    res.cookie("accessToken", accessToken, {
        ...
        secure: false, // à enlever au déploiment 
    });
