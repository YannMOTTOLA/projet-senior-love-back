...
export async function getTenLatestMembers(req, res) {
    const members = await prisma.user.findMany({
        where: {
            role: { name: "member" },
        },
...
export async function getNumberOfNewMemberLastWeek(req, res) {
...
export async function desactiveOneMemberfor48Hours(req, res) {
    const id = req.params.id;
    const user = await prisma.user.findFirst({
        where: {
            id: { contains: id },
...
export async function desactiveOneMemberfor1Week(req, res) {
    const id = req.params.id;
    const user = await prisma.user.findFirst({
        where: {
            id: { contains: id },
...
export async function activateOneMember(req, res) {
    const id = req.params.id;
    const user = await prisma.user.findFirst({
        where: {
            id: { contains: id },
...
export async function getAllDesactivatedMember(req, res) {
